...
public class SkeletonCameraRT : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // The camera is a child of hips, so parent = hips
        hips = transform.parent;

        // Cache forward direction once so bone rotation doesn't affect it
    ...
    private void LateUpdate()
    {
        ...
        // Follow the hips position — wherever it goes, including -13
